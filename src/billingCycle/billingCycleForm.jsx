        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <Field name='month' component={labelAndInput} label='Mês' cols='12 4' readOnly={readOnly} placeholder='Informe o mês' />
                    <Field name='year' component={labelAndInput} label='Ano' cols='12 4' readOnly={readOnly} placeholder='Informe o ano' />
...
const selector = formValueSelector('billingCycleForm') //getting values from form 
